...
Food(name: "Aloha Burger",
    ...
    imagePath: "lib/images/burgers/aloha_burger1.jpg",
    price: 0.99,
    category: FoodCategory.burgers,
    availableAddons:[
      Addon(name: "Extra cheese", price: 0.99),
...
Food(name: "Blue Moon Burger",
  ...
  Food(name: "Geek Salad",
    ...
    imagePath: "lib/images/salads/geek_salad.jpg",
    price: 0.99,
    category: FoodCategory.salads,
    availableAddons:[
  ...
  Food(name: "South West Chicken Salad",
    ...
    imagePath: "lib/images/salads/southeast_salad.jpg",
    price: 9.99,
    category: FoodCategory.salads,
    availableAddons:[
  ...
  Food(name: "Onion Rings",
    ...
    imagePath: "lib/images/sides/onion_rings_side1.jpg",
    price: 9.99,
    category: FoodCategory.sides,
    availableAddons:[
  ...
  Food(name: "Six Baked Breads",
    description: "Rich and fudgy chocolate brownie,with chunks of chocolate.",
    imagePath: "lib/images/desserts/breads.jpg",
    price: 9.99,
    category: FoodCategory.desserts,
    availableAddons:[
      Addon(name: "Vanilla Ice Cream", price: 0.99),
